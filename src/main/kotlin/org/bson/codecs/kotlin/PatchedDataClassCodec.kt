...
internal data class PatchedDataClassCodec<T : Any>(
    ...
    override fun decode(reader: BsonReader, decoderContext: DecoderContext): T {
        ...
        // Source: https://github.com/mongodb/mongo-java-driver/blob/a6d7d1d6c042b46969ed6cc509ad36e809130d00/bson-kotlin/src/main/kotlin/org/bson/codecs/kotlin/DataClassCodec.kt#L102
        // Remove null values for parameters with default values to avoid passing null
        primaryConstructor.parameters
            .filter { it.isOptional && args[it] == null }
            .forEach { args.remove(it) }
    ...
    companion object {
        ...
        internal fun <R : Any> create(
            ...
            return if (kClass.isData) {
                ...
                return PatchedDataClassCodec(kClass, primaryConstructor, propertyModels)
            } else {
                null
            }
        }
        ...
        private fun CodecRegistry.getCodec(kParameter: KParameter, clazz: Class<Any>, types: List<Type>): Codec<Any> {
            val codec =
                if (clazz.isArray) {
                    // CHANGES FROM THE ORIGINAL
                    ArrayCodecProvider()[clazz, types, this]!!
